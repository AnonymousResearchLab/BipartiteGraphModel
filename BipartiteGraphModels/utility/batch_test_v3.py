...
def test(sess, model, users_to_test, drop_flag=False, batch_test_flag=False):
    ...
    for u_batch_id in range(n_user_batchs):
        ...
        user_batch = data_generator.sample_path(test_users[start: end], path=data_generator.user_path, neighbors_num=neighbors_num)
        ...
        if batch_test_flag:
            ...
            for i_batch_id in range(n_item_batchs):
                ...
                item_batch_u = data_generator.sample_path(range(i_start, i_end), path=data_generator.item_path, neighbors_num=neighbors_num)
                # item_batch_i = data_generator.sample_path(range(i_start, i_end), path=['i', 'i'], neighbors_num=neighbors_num)
            ...
            item_batch_u = data_generator.sample_path(item_batch, path=data_generator.item_path, neighbors_num=neighbors_num)
