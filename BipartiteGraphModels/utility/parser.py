...
def parse_args():
    ...
    parser.add_argument('--neighbors_num', nargs='?', default='[64]', help='Default number of neighbors per node')

    parser.add_argument('--niter', type=int, default=4, help='ppr iteration num')
    parser.add_argument('--weighted_sample_num', type=int, default=5, help='default weighted sample num')
