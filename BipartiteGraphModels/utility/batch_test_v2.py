...
from utility.load_data_v2 import *
...
#         user_batch = data_generator.sample_path(test_users[start: end], path=['u', 'i'], neighbors_num=[30])
...
#                 item_batch_u = data_generator.sample_path(range(i_start, i_end), path=['i', 'u'], neighbors_num=[30])
#                 item_batch_i = data_generator.sample_path(range(i_start, i_end), path=['i', 'i'], neighbors_num=[30])
...
#                                                                 model.pos_items_u: item_batch_u,
#                                                                 model.pos_items_i: item_batch_i,
...
#             item_batch_u = data_generator.sample_path(item_batch, path=['i', 'u'], neighbors_num=[30])
#             item_batch_i = data_generator.sample_path(item_batch, path=['i', 'i'], neighbors_num=[30])
